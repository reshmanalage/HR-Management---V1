    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <Field label="UAN Number">
            <input className={inputCls} value={stat.uan_number ?? ""} onChange={set("uan_number")} placeholder="12-digit UAN" maxLength={12} />
          </Field>
          <Field label="PF Member ID">
            <input className={inputCls} value={stat.pf_member_id ?? ""} onChange={set("pf_member_id")} placeholder="MH/BAN/1234567/000/0000001" />
          </Field>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <Field label="ESIC IP Number">
            <input className={inputCls} value={stat.esic_ip_number ?? ""} onChange={set("esic_ip_number")} placeholder="17-digit IP number" />
          </Field>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <Field label="Aadhaar Number">
            <input className={inputCls} value={stat.aadhaar_number ?? ""} onChange={set("aadhaar_number")} placeholder="12-digit Aadhaar" maxLength={12} />
          </Field>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Toggle label="KYC Verified" checked={stat.kyc_verified ?? false} onChange={toggle("kyc_verified")} hint="Overall KYC completion" />
        </div>
      </div>
    </div>
  );
