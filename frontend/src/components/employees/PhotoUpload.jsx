  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div
        ...
        className="relative w-28 h-28 rounded-full border-2 border-dashed border-gray-300 flex items-center justify-center cursor-pointer hover:border-indigo-400 transition-colors overflow-hidden bg-gray-50"
      >
        {preview ? (
          ...
          <div className="text-center text-gray-400 text-xs px-2">
            <svg className="mx-auto mb-1 w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
