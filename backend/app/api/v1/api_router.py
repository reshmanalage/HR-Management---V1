...
from app.api.v1.routers.attendance_router import router as attendance_router
from app.api.v1.routers.regularization_router import router as regularization_router
...
from app.api.v1.routers.module_access_router import router as module_access_router
from app.api.v1.routers.payroll_router import router as payroll_router

api_router = APIRouter()
api_router.include_router(auth_router)
api_router.include_router(user_router)
api_router.include_router(module_access_router)
